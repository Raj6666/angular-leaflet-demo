...
/* harmony import */ var _map_map_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./map/map.service */ "./src/app/map/map.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [
                ...
                _map_map_service__WEBPACK_IMPORTED_MODULE_20__["MapApi"]
            ],
...
var IndexComponent = /** @class */ (function () {
    function IndexComponent(map, route, router, 
    ...
    ], IndexComponent.prototype, "mapElement", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('f_type'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], IndexComponent.prototype, "f_type_element", void 0);
    IndexComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            template: __webpack_require__(/*! ./index.component.html */ "./src/app/index/index.component.html"),
            styles: [__webpack_require__(/*! ./index.component.scss */ "./src/app/index/index.component.scss")]
        }),
        __metadata("design:paramtypes", [_map_map_service__WEBPACK_IMPORTED_MODULE_3__["MapApi"],
...
/* harmony import */ var _assets_leafletLocalMap_leaflet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../assets/leafletLocalMap/leaflet */ "./src/assets/leafletLocalMap/leaflet.js");
/* harmony import */ var _assets_leafletLocalMap_leaflet__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_assets_leafletLocalMap_leaflet__WEBPACK_IMPORTED_MODULE_2__);
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MapApi = /** @class */ (function () {
    function MapApi() {
        this.myMap = null;
        this.greenIcon = null;
    }
    MapApi.prototype.init = function (opts) {
        var contain = opts.contain, f_type = opts.f_type;
        ...
        var tiles = new L.GridLayer(gridLayerOptions);
        tiles.createTile = function (coords) {
            ...
            var firstAbsPoint = coords.scaleBy(size);
            // 根据绝对像素坐标，以及缩放层级，反投影得到其经纬度
            var firstPoint = map.unproject(firstAbsPoint, coords.z);
            // 获取当前栅格右下角经纬度坐标点-------------------------------------
            var originLastPoint = new _assets_leafletLocalMap_leaflet__WEBPACK_IMPORTED_MODULE_2__["Point"](coords.x + 1, coords.y + 1);
            var lastAbsPoint = originLastPoint.scaleBy(size);
            var lastPoint = map.unproject(lastAbsPoint, coords.z);
            // 默认栅格填充绿色
            ctx.fillStyle = 'lightgreen';
            ctx.fillRect(0, 0, size.x, size.y);
            // 若该点在指定区域内，则栅格填充红色
            var testPoint = [114.435142, 23.080344];
            if (firstPoint.lng <= testPoint[0] && testPoint[0] <= lastPoint.lng && firstPoint.lat >= testPoint[1] && testPoint[1] >= lastPoint.lat) {
                ctx.fillStyle = 'red';
                ctx.fillRect(0, 0, size.x, size.y);
            }
            var actualCoords = map.unproject(firstAbsPoint, coords.z);
            ctx.fillStyle = 'black';
        ...
        // 设置瓦片图链接
        L.tileLayer(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].tileLayer).addTo(this.myMap);
        // 把栅格图层添加至地图
        ...
        this.greenIcon = L.icon({
            iconUrl: './assets/leafletLocalMap/images/marker-icon.png',
            iconSize: [20, 30],
            iconAnchor: [10, 30],
        });
    };
    MapApi.prototype.renderF_Type = function (el) {
        var F_Type = this.myMap.createPane('F_Type', el);
        console.log(F_Type);
    };
    MapApi = __decorate([
...
var TestComponent = /** @class */ (function () {
    function TestComponent(elementRef) {
        ...
        this.transNodes = [];
        this.maxLevelOfNodes = 0;
        this.checkedNode = ['10010'];
        this.selectedNode = [];
    }
    TestComponent.prototype.nzCheck = function (event) {
        console.log(event);
    };
    ...
    TestComponent.prototype.treeData = function (data) {
        var tree = data.filter(function (father) {
            var branchArr = data.filter(function (child) {
    ...
    TestComponent.prototype.readTreeData = function (node) {
        // 把需要转换的节点放到一个数组中
    ...
    TestComponent.prototype.addNode = function (node) {
        if (!node.isLeaf) {
            var _loop_1 = function (i) {
                if ((node.level + 1) === i) {
                    this_1.transNodes.forEach(function (transNode) {
                        if (transNode.level === i && node.key === transNode.parentNode.key) {
                            var nodeIsExist_1 = false;
                            // 判断是否已添加该节点
            ...
            for (var i = 1; i <= this.maxLevelOfNodes; i++) {
                _loop_1(i);
            }
        }
        if (node.children && node.children.length > 0) {
    ...
    TestComponent.prototype.removeNode = function (node) {
        var _this = this;
        // 把半选状态都去掉
        ...
        if (node.isChecked === true && node.parentNode !== null) {
            // console.log(node); // 单个节点
            node.parentNode.children.forEach(function (child) {
                if (node.key === child.key) {
                    var index = node.parentNode.children.indexOf(child);
                    node.parentNode.children.splice(index, 1);
                    _this.removeNode(node.parentNode);
                }
            });
        }
    ...
    TestComponent.prototype.removeSpecNode = function (node, key, finded) {
        // 把需要转换的节点放到一个数组中
    ...
    TestComponent.prototype.toLeft = function () {
        this.readTreeData(this.selectedTreeCom.nzNodes[0]);
        this.addNode(this.waitSelectTreeCom.nzNodes[0]);
        this.removeNode(this.selectedTreeCom.nzNodes[0]);
        this.transNodes = [];
    };
    TestComponent.prototype.toRight = function () {
        this.readTreeData(this.waitSelectTreeCom.nzNodes[0]);
        this.addNode(this.selectedTreeCom.nzNodes[0]);
        this.removeNode(this.waitSelectTreeCom.nzNodes[0]);
        this.transNodes = [];
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('waitSelectTreeCom'),
        __metadata("design:type", Object)
    ], TestComponent.prototype, "waitSelectTreeCom", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('selectedTreeCom'),
        __metadata("design:type", Object)
    ], TestComponent.prototype, "selectedTreeCom", void 0);
...
/***/ "./src/assets/leafletLocalMap/leaflet.js":
/*!***********************************************!*\
  !*** ./src/assets/leafletLocalMap/leaflet.js ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! D:\Project\leafletDemo\src\main.ts */"./src/main.ts");
